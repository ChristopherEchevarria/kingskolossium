/***
Path: /kingskolossium/src/features/build/components/totals/CombatStats.tsx
Created by: Christopher Echevarria
Date of creation: 06May2026
Purpose and Description: Combat stat group card — AP, MP, Range, Critical %, Power, Summons.
  AP and MP include level-based base values. Wrapped in liquid-glass island.
***/
  ...
  return (
    <div className="liquid-glass rounded-xl p-3 flex flex-col gap-1.5">
      <span className="font-mono text-[9px] text-white/25 uppercase tracking-widest mb-0.5">
        {STAT_GROUPS.combat.label}
      </span>
      {STAT_GROUPS.combat.stats.map(({ characteristic_id, element_id, icon }) => {
